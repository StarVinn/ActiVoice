...
def main():
    ...
    if not profile_names:
        ...
        profiles = {active_name: {"aplikacje": cfg.get("aplikacje", []), "terminale": cfg.get("terminale", []), "slowa_kluczowe": cfg.get("slowa_kluczowe", "")}}
    ...
    def add_profile():
        ...
        current_profile["data"][name] = {"aplikacje": [], "terminale": [], "slowa_kluczowe": ""}
    ...
    voice_kw_var = ctk.StringVar(value=active_data.get("slowa_kluczowe", cfg.get("slowa_kluczowe", "")))
    ...
    def save_current_to_profile():
        ...
        current_profile["data"][current_profile["name"]] = {
            "aplikacje": apps,
            "terminale": terms,
    ...
    def switch_profile(new_name):
        ...
        voice_kw_var.set(data.get("slowa_kluczowe", cfg.get("slowa_kluczowe", "")))
    ...
    ctk.CTkLabel(voice_frame, text="Keywords are saved per profile. Separate words with comma. Leave empty to disable.",
                 text_color="#888").pack(anchor="w", padx=16, pady=(2, 8))
